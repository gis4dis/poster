...
class Observation(models.Model):
    phenomenon_time = models.DateTimeField(
        help_text="Time that the result applies to the property of the feature-of-interest. This is often the time of "
                  "interaction by a sampling procedure or observation procedure with a real-world feature.",
        editable=False
    )
    ...
    class Meta:
        ...
        unique_together = (
            ('phenomenon_time', 'phenomenon_time_to', 'observed_property', 'feature_of_interest', 'procedure'),
        )
